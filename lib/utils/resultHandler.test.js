...
var resultHandler_1 = tslib_1.__importDefault(require("./resultHandler"));
describe('ResultHandler', function () {
    var _a;
    var resultHandlerErrorBoolean = resultHandler_1.default((_a = {
        ...
        _a));
    var resultHandlerNumber = resultHandler_1.default({
