...
(function (CSGO) {
    CSGO.BLUEPRINTS = {
        MAP: function (name) { return ({ name: name, id: idGenerator_1.idGenerator(name, { uppercase: true }) }); },
...
exports.CSGOFACTORYFN.ADD_EQUIPMENT({ name: 'SSG-01', id: 'SSG01', cost: 1700, side: 'UNI' });
