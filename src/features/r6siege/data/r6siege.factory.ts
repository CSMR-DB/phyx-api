...
export namespace R6SIEGE {
  export interface IMap {
    name: string
    internal_id: string
    official: boolean
    walls: { internal_id: string; reinforceable: boolean }[]
    doorways: string[]
    windows: string[]
  }
  ...
  export function DATAFACTORY(options: {
    ...
    function categorizer(slot: string, category: string) {
      const categoryOptions: { [key: string]: { categories: string[] } } = {
    ...
    function getOperators(): IOperator[] {
...
R6SIEGEFACTORY.addOperator(
  ...
  [ 'MK17CQB', 'SR25' ],
  [ 'D50' ],
  [ 'BREACHCHARGE', 'STUNGRENADE' ],
  [ 'TARS MK 0 Rifle Shield', false, 2 ]
)
...
R6SIEGEFACTORY.addOperator(
  ...
  [],
  [ 'P12' ],
  [ 'SMOKEGRENADE', 'BREACHCHARGE' ],
  [ 'G52-Tactical Shield', false, Infinity ]
)
...
R6SIEGEFACTORY.addOperator(
  ...
  [ 'C8SFW', 'CAMRS' ],
  [ 'MK19MM' ],
  [ 'FRAGGRENADE', 'STUNGRENADE' ],
  [ 'SK 4-12 (Skeleton Key)', true, 24 ]
)
...
R6SIEGEFACTORY.addOperator(
  ...
  [ 'PARA308', 'M249' ],
  [ 'PRB92' ],
  [ 'CLAYMORE', 'STUNGRENADE' ],
  [ 'TAC MK0 Tactical Crossbow', true, 6 ]
)
...
R6SIEGEFACTORY.addOperator(
  ...
  'Finka',
  'CBRN',
  [ 'SPEAR308', '6P41', 'SASG12' ],
  [ 'PMM', 'GSH18' ],
  [ 'BREACHCHARGE', 'FRAGGRENADE' ],
  [ 'Nanobot Shots', false, 3 ]
)
...
R6SIEGEFACTORY.addOperator(
  ...
  'Fuze',
  'Spetsnaz',
  [ 'AK12', '6P41', 'BALLISTICSHIELD' ],
  [ 'PMM', 'GSH18' ],
  [ 'BREACHCHARGE', 'SMOKEGRENADE' ],
  [ 'APM-6 "Matryoshka" Cluster Charge', true, 3 ]
)
...
R6SIEGEFACTORY.addOperator(
  ...
  [ 'OTS03' ],
  [ 'PMM', 'GSH18' ],
  [ 'SMOKEGRENADE', 'CLAYMORE' ],
  [ 'HDS Flip Sight', false, -1 ]
)
...
R6SIEGEFACTORY.addOperator(
  ...
  'IQ',
  'GSG 9',
  [ 'AUGA2', '552COMMANDO', 'G8A1' ],
  [ 'P12' ],
  [ 'BREACHCHARGE', 'CLAYMORE' ],
  [ 'Red MKIII "Spectre" Electronics Detector', false, Infinity ]
)
...
R6SIEGEFACTORY.addOperator(
  ...
  [ '1911TACOPS' ],
  [ 'STUNGRENADE', 'CLAYMORE' ],
  [ 'Exothermic-S "SURI" Torch', true, 5 ]
)
...
R6SIEGEFACTORY.addOperator(
  ...
  [ 'P9', 'LFP586' ],
  [ 'STUNGRENADE', 'SMOKEGRENADE' ],
  [ '"Le Roc" Extendable Shield', false, Infinity ]
)
...
R6SIEGEFACTORY.addOperator(
  ...
  [ 'AK74M', 'ARX200' ],
  [ '44MAGSEMIAUTO' ],
  [ 'CLAYMORE', 'BREACHCHARGE' ],
  [ 'Airjab Launcher', true, 3 ]
)
...
R6SIEGEFACTORY.addOperator(
  ...
  [ 'P9', 'LFP586' ],
  [ 'BREACHCHARGE', 'CLAYMORE' ],
  [ 'RSD Model 1 (Shock Drone)', true, 2 ]
)
...
R6SIEGEFACTORY.addOperator(
  ...
  'G.I.S',
  [ 'ACS12', 'MX4STORM' ],
  [ 'BAILIFF410', 'KERATOS357' ],
  [ 'IMPACTGRENADE', 'DEPLOYABLESHIELD' ],
  [ 'Prisma', true, 3 ]
)
...
R6SIEGEFACTORY.addOperator(
  ...
  [ 'M870', 'MP7' ],
  [ 'P12' ],
  [ 'BARBEDWIRE', 'NITROCELL' ],
  [ 'CED-1 (Crude Electrical Device)', true, 4 ]
)
...
R6SIEGEFACTORY.addOperator(
  ...
  [ 'UMP45', 'M1014' ],
  [ '57USG', 'M45MEUSOC' ],
  [ 'BULLETPROOFCAMERA', 'IMPACTGRENADE' ],
  [ 'UTP1-Universal Tactical Panel', true, 5 ]
)
...
R6SIEGEFACTORY.addOperator(
  ...
  [ 'MP5', 'P90', 'SGCQB' ],
  [ 'P9', 'LFP586' ],
  [ 'BULLETPROOFCAMERA', 'BARBEDWIRE' ],
  [ 'MPD-0 Stim Pistol', false, 3 ]
)
...
R6SIEGEFACTORY.addOperator(
  ...
  [ 'MK19MM' ],
  [ 'BULLETPROOFCAMERA', 'BARBEDWIRE' ],
  [ 'Sterling MK2 LHT (Welcome Mat)', true, 3 ]
)
...
R6SIEGEFACTORY.addOperator(
  ...
  [ 'AUGA3', 'TCSG12' ],
  [ '44MAGSEMIAUTO' ],
  [ 'BARBEDWIRE', 'IMPACTGRENADE' ],
  [ '"Rtila" Electroclaw', true, 2 ]
)
...
R6SIEGEFACTORY.addOperator(
  ...
  [ '9X19VSN', 'SASG12' ],
  [ 'PMM', 'GSH18' ],
  [ 'IMPACTGRENADE', 'NITROCELL' ],
  [ 'EDD MK II Entry Denial Device', true, 5 ]
)
...
R6SIEGEFACTORY.addOperator(
  ...
  [ 'MP5K', 'M590A1' ],
  [ 'P226MK25', 'SMG11' ],
  [ 'BULLETPROOFCAMERA', 'NITROCELL' ],
  [ 'GC90 Signal Disruptor', true, 3 ]
)
...
R6SIEGEFACTORY.addOperator(
  ...
  [ '57USG', 'M45MEUSOC' ],
  [ 'BARBEDWIRE', 'NITROCELL' ],
  [ 'HB-5 Cardiac Sensor', false, Infinity ]
)
...
R6SIEGEFACTORY.addOperator(
  ...
  [ 'MP5', 'P90', 'SGCQB' ],
  [ 'P9', 'LFP586' ],
  [ 'DEPLOYABLESHIELD', 'IMPACTGRENADE' ],
  [ 'R1N "Rhino" Armor', true, 1 ]
)
...
R6SIEGEFACTORY.addOperator(
  ...
  [ 'P226MK25', 'SMG11' ],
  [ 'BARBEDWIRE', 'IMPACTGRENADE' ],
  [ 'Compound Z8 (Remote Gas Grenade)', true, 3 ]
)
...
R6SIEGEFACTORY.addOperator(
  ...
  [ 'PMM', 'GSH18' ],
  [ 'BARBEDWIRE', 'DEPLOYABLESHIELD' ],
  [ 'RP-46 Degtyaryov Machine Gun', true, 1 ]
)
